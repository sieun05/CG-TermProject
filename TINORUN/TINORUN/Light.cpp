...
#include <cmath>
#include <algorithm>
#include <string>  // to_string �Լ� ����� ���� �߰�

// �ʿ��� extern ����� (shader_func.h ���)
...
void LightManager::SetupSunlight() {
    ...
    Light sunlight = Light::CreateDirectionalLight(
        glm::vec3(0.0f, -1.0f, 0.0f),      // 빛의 방향 (위에서 아래로)
        glm::vec3(2.0f, 2.0f, 2.0f),       // 밝은 환경광
        glm::vec3(2.5f, 2.5f, 2.5f),       // 밝은 확산광
        glm::vec3(2.0f, 2.0f, 2.0f)        // 밝은 반사광
    );
